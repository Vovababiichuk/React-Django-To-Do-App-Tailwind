...
function App() {
  ...
  return (
    <div className="max-w-screen-xl p-0 md:p-5 mx-auto">
        ...
        <div className="flex flex-col w-full p-10">
          ...
          <div className="mt-5 flex flex-col space-y-5 sm:space-y-0 sm:grid sm:grid-cols-2 sm:gap-10 lg:grid-cols-3">
            ...
            {todos?.map((todo, index) => (
              <div
                key={todo.id}
                className="max-w-md mx-auto w-full p-5 h-full rounded-xl bg-blue-500 flex justify-between">
                ...
                <div className='flex items-center gap-2'>
                  ...
                  <i>
                    ...
                    className="icons hover:opacity-70" />
                  </i>
                </div>
              </div>
            ))}
